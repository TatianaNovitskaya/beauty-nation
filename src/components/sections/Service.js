...
export default function Service() {
    return (
        <section className={"py-[4.75rem]"}>
            <div className={`${montserrat.className} text-[#767676] container flex flex-col sm:flex-row h-full relative sm:justify-around items-center sm:items-baseline sm:grid-cols-3 gap-[2rem] md:gap-[10rem]`}>
                <div className={"flex flex-col items-center w-[80%] sm:w-1/3 text-center"}>
