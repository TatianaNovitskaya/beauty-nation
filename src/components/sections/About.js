...
export default function About() {
    return (
        <section className={"md:py-[4rem]"} id={"about"}>
            <div className={`${montserrat.className} flex flex-col items-center md:items-start md:flex-row text-[#767676] container h-full relative grid-cols-2 gap-[3rem]`}>
