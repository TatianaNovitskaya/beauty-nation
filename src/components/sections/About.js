            ...
            <div className={`${montserrat.className} flex text-[#767676] container  h-full relative grid-cols-2 gap-[3rem]`}>
                ...
                <div className={"w-1/2"}>
                    <article>
                        ...
                        <p className={"indent-6 my-[0.7rem]"}>Whether you're looking for a classic manicure or a bold, unique nail design, I'm here to bring your vision to life. Your nails are an extension of your personality, and I'm here to help you express yourself through them. From timeless elegance to avant-garde creativity, I've got you covered.</p>
